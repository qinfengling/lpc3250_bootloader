/***********************************************************************
 * $Id:: sys_mmu_cmd_group.c 903 2008-07-17 21:01:44Z wellsk           $
 *
...
static CMD_ROUTE_T core_dcache_cmd =
{
	"dcache",
	cmd_dcache,
	"Enables, disables, or flushes data cache",
	"dcache [0(disable), 1(enable), 2(flush)]",
	cmd_dcache_plist,
	NULL
};
...
static CMD_ROUTE_T core_icache_cmd =
{
	"icache",
	cmd_icache,
	"Enables or disables instruction cache",
	"icache [0(disable), 1(enable)]",
	cmd_icache_plist,
	NULL
};
...
static CMD_ROUTE_T core_inval_cmd =
{
	"inval",
	cmd_inval,
	"Flushes data cache and invalidates instruction cache",
	"inval",
	cmd_inval_plist,
	NULL
};
...
static CMD_ROUTE_T core_map_cmd =
{
	"map",
	cmd_map,
	"Maps a range of physical address sections to virtual addresses",
	"map [virt hex addr][phy hex addr][sections][0(uncached), 1(cached), 2(unmap)]",
	cmd_map_plist,
	NULL
};

/* mmuinfo command */
BOOL_32 cmd_mmuinfo(void);
