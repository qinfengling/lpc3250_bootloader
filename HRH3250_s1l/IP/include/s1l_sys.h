/***********************************************************************
 * $Id:: s1l_sys.h 975 2008-07-29 18:29:28Z wellsk                     $
 *
...
typedef struct 
{
	...
	UNS_32 verikey;      /* Key to verify this structure */
} S1L_CFG_T;
...
typedef struct
{
	...
	/* Maximum amount of blocks available for saved FLASH applications
	   stored at blafter bootloader blocks, use 0xFFFFFFFF for maximum
	   blocks */
	UNS_32 app_num_blks;
} S1L_SYS_RTCFG_T;
...
{
	UNS_32 blocks;
	UNS_32 sectors_per_block;
	UNS_32 data_bytes_per_sector;
	UNS_32 addrcycles;
} FLASH_GEOM_T;
