/***********************************************************************
 * $Id:: s1l_cmds.c 871 2008-07-07 22:36:49Z wellsk                    $
 *
...
static CMD_ROUTE_T cmd_list_head =
{
	...
	cmd_help,
	"S1L help group",
	"help [all, menu, group name, command name]",
	cmd_help_plist,
	NULL
};
...
{
	cmd_strout_format(0, "Command:", 12, pCmd->keystr);
	cmd_strout_format(0, "Purpose:", 12, pCmd->help_str);
	cmd_strout_format(0, "syntax:", 12, pCmd->syntax);
}
