/***********************************************************************
 * $Id:: s1l_bootmgr.c 976 2008-07-29 18:29:47Z wellsk                 $
 *
...
//		cfg_save(&syscfg);
	...
	term_dat_out(__DATE__);
	term_dat_out(" ");
	term_dat_out_crlf(__TIME__);
	...
	/* Query FLASH */
	sysinfo.nandgood = flash_init(&sysinfo.nandgeom);
