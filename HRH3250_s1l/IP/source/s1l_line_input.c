/***********************************************************************
 * $Id:: s1l_line_input.c 988 2008-08-05 17:13:32Z wellsk              $
 *
...
static UNS_8 str_hist[256][MAX_HISTORY];
static UNS_8 hist_index, hist_items;
#endif
 ...
 *
 * Processing:
 *     Sets the current commadn prompt.
 *
 * Parameters:
