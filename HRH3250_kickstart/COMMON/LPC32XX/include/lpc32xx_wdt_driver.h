/***********************************************************************
 * $Id:: lpc32xx_wdt_driver.h 1117 2008-08-21 21:00:24Z stefanovicz    $
 *
...
#ifndef LPC32XX_WDT_DRIVER_H
#define LPC32XX_WDT_DRIVER_H
...
typedef enum
{
  ...
  WDT_PAUSE_ENABLE,   /* enable pause while debugging */
  WDT_PAUSE_DISABLE   /* disable pause while debugging */
} WDT_IOCTL_TIMER_OPT;
