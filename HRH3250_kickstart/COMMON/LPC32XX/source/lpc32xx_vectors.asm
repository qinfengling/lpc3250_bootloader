/*;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
; $Id:: lpc32xx_vectors.asm 1132 2008-08-22 21:55:40Z wellsk           $
; 
...
vec_reset_handler:
    .word lpc32xx_reset_handler

vec_undefined_handler:
    .word lpc32xx_undefined_handler

vec_swi_handler:
    .word lpc32xx_swi_handler

vec_prefetch_handler:
    .word lpc32xx_prefetch_handler

vec_abort_handler:
    .word lpc32xx_abort_handler

vec_irq_handler:
    .word lpc32xx_irq_handler

vec_fiq_handler:
    .word lpc32xx_fiq_handler
